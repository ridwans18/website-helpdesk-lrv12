    ...
    <body class="flex flex-col min-h-screen d-flex flex-column min-vh-100">
        @php
            ...
            $navbarLinks = [
                ...
                ['href' => route('laporan.index'), 'class' => 'text-white bg-gray-900', 'text' => 'Laporan'],
            ];  
        ...
        <main class="flex-grow container mx-auto px-4 py-6">
            <div class="mt-10 bg-white p-6 rounded-lg shadow-md">
                <h2 class="text-lg sm:text-xl md:text-1xl lg:text-2xl font-semibold mb-6 text-gray-800">📄 Cetak Berdasarkan Tanggal</h2>
                    ...
                    <table class="min-w-full table-auto text-sm border border-gray-200 rounded-md overflow-hidden">
                        <thead class="bg-gray-100 text-gray-700 text-sm font-semibold">
                            <tr>
                                ...
                                <th class="px-3 py-2 border">Nota Dinas</th>
                        ...
                        <tbody class="text-gray-800">
                            ...
                            <tr class="odd:bg-white even:bg-gray-50">
                                ...
                                <td class="px-3 py-2 border">{{ $item->notadinas }}</td>
                                ...
                                <td class="px-3 py-2 border text-center">{{ \Carbon\Carbon::parse($item->deadline)->format('d-m-Y') }}</td>
                                <td class="px-3 py-2 border text-center">
                                    @switch($item->status)
                                        @case(1) <span class="text-gray-500">Open</span> @break
                                        @case(2) <span class="text-yellow-500">Diproses</span> @break
                                        @case(3) <span class="text-green-500">Close</span> @break
                                        @case(4) <span class="text-red-700">Overdue</span> @break
                                        @default <span class="text-red-700">Tidak Diketahui</span>
                                    @endswitch
                                </td>
                            </tr>
                            @endforeach
